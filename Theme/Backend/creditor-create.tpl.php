    ...
    <div class="inner">
        <form>
            <table class="layout w-100">
                <tr><td><label for="iStatus"><?= $this->l11n->lang['AccountsPayable']['Status'] ?></label>
                <tr><td><select id="iStatus" name="status">
                            <option>
                        </select>
                <tr><td><label for="iStatus"><?= $this->l11n->lang['AccountsPayable']['DeliveryStatus'] ?></label>
                <tr><td><select id="iStatus" name="status">
                            <option>
                        </select>
                ...
                <tr><td><label for="iName3"><?= $this->l11n->lang['AccountsPayable']['Name3']; ?></label>
