...
<section class="box w-25 floatLeft">
    <div class="inner centerText">
        <a href="">
            ...
            <p><?= $this->l11n->getText('AccountsPayable', 'Backend', 'Due') ?></p>
        </a>
    </div>
</section>
...
<section class="box w-25 floatLeft">
    <div class="inner centerText">
        <a href="">
            ...
            <p><?= $this->l11n->getText('AccountsPayable', 'Backend', 'DSO') ?></p>
        </a>
    </div>
</section>
...
<section class="box w-25 floatLeft">
    <div class="inner centerText">
        <a href="">
            ...
            <p><?= $this->l11n->getText('AccountsPayable', 'Backend', 'AgePattern') ?></p>
        </a>
    </div>
</section>
